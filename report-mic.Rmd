---
title: "`r params$center` Manufacturing/Industrial Center"
output: 
...
df_filled <- df |> 
  select(center_name, center_type, existing_jobs, planned_jobs, industrial_employment, size, transit_service, core_ind_uses, ind_ret_strategies, subarea_plan) 
